...
type FuncPoolInterface interface {
	Create(*v1.FuncPool) (*v1.FuncPool, error)
	Update(*v1.FuncPool) (*v1.FuncPool, error)
	UpdateStatus(*v1.FuncPool) (*v1.FuncPool, error)
	Delete(name string, options *metav1.DeleteOptions) error
	DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error
	Get(name string, options metav1.GetOptions) (*v1.FuncPool, error)
	List(opts metav1.ListOptions) (*v1.FuncPoolList, error)
	Watch(opts metav1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.FuncPool, err error)
	FuncPoolExpansion
}
...
func newFuncPools(c *ServingV1Client, namespace string) *funcPools {
	return &funcPools{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *funcPools) Get(name string, options metav1.GetOptions) (result *v1.FuncPool, err error) {
	result = &v1.FuncPool{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("funcpools").
...
func (c *funcPools) List(opts metav1.ListOptions) (result *v1.FuncPoolList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.FuncPoolList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("funcpools").
...
func (c *funcPools) Create(funcPool *v1.FuncPool) (result *v1.FuncPool, err error) {
	result = &v1.FuncPool{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("funcpools").
...
func (c *funcPools) Update(funcPool *v1.FuncPool) (result *v1.FuncPool, err error) {
	result = &v1.FuncPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("funcpools").
...
func (c *funcPools) UpdateStatus(funcPool *v1.FuncPool) (result *v1.FuncPool, err error) {
	result = &v1.FuncPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("funcpools").
...
func (c *funcPools) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.FuncPool, err error) {
	result = &v1.FuncPool{}

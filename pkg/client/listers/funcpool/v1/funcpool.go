...
type FuncPoolLister interface {
	...
	List(selector labels.Selector) (ret []*v12.FuncPool, err error)
...
// List lists all FuncPools in the indexer.
func (s *funcPoolLister) List(selector labels.Selector) (ret []*v12.FuncPool, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v12.FuncPool))
	})
	return ret, err
}
...
type FuncPoolNamespaceLister interface {
	...
	Get(name string) (*v12.FuncPool, error)
...
// List lists all FuncPools in the indexer for a given namespace.
func (s funcPoolNamespaceLister) List(selector labels.Selector) (ret []*v12.FuncPool, err error) {
...
// Get retrieves the FuncPool from the indexer for a given namespace and name.
func (s funcPoolNamespaceLister) Get(name string) (*v12.FuncPool, error) {
